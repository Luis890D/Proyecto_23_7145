...
public class Ejemplos {
    ...
    btnProcesar.addActionListener(e -> {
        ...
        // ✅ Mostrar panel lateral al procesar
        PanelLateral.mostrar(escritorio);

        // ✅ Procesar el texto y construir el diagrama
        Nuevo.procesarTexto(texto, escritorio);

        // ✅ Si el panel gráfico ya está creado, actualiza la gráfica
        GraficaDiagrama grafica = PanelLateral.getPanelGrafica();
        if (grafica != null && grafica.getDiagrama() != null) {
            grafica.actualizarColoresDiagrama(grafica.getDiagrama());
        }
    });
    ...
    // ✅ Mostrar el panel lateral inmediatamente al abrir la hoja
    PanelLateral.mostrar(escritorio);
